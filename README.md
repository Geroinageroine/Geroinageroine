...
Использую **Python** для анализа данных (**pandas**, **numpy**, **matplotlib**, **seaborn**), оформляю результаты в моем [**Google Colab**](https://drive.google.com/drive/folders/1PpcdDdHLqWnZILIx4xbFFVaraykf6H4q?usp=sharing)
...
### Cертификаты
[1 Введение в Data Science и машинное обучение](https://stepik.org/cert/1092529)
